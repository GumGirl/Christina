...
// ver 1. rolls 2 dice and turns the output for 1 player. That player choses the dice order and get the correct return output.
// ver 2. refactored code to include player 2
//    - global variable for currentPlayer; allPlayerScore
...
var getPlayerScore = function (playerInput) {
  ...
  if (playerInput != 1 && playerInput != 2) {
    ...
    return (
      "Error! please only input '1' or '2' to choose which dice to use as the first digit <br><br><br> Your dice rolls are: <br> Dice 1: " +
      currentPlayerRolls[0] +
      " | Dice 2: " +
      currentPlayerRolls[1] +
      "."
  ...
  if (playerInput == 2) {
    ...
    playerScore = Number(
      String(currentPlayerRolls[1]) + String(currentPlayerRolls[1])
    );
    return "Your chosen value is " + playerScore;
  }
  ...
  currentPlayerRolls = [];
  return "Player " + currentPlayer + ", your chosen valye is: " + playerScore;
};
